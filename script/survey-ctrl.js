...
app.controller('myCtrl', function($scope) {
    $scope.sample= [{id:0,identicon:'01',url:'samples/sample1.wav', etat:''},
					{id:1,identicon:'02',url:'samples/sample1.wav', etat:''},
					{id:2,identicon:'03',url:'samples/sample1.wav', etat:''},
